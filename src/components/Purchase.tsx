        ...
        >
          ...
          >
            <div className="flex items-center justify-center min-h-screen">
              <Dialog.Panel className="w-full max-w-xs md:max-w-xl  px-6 py-4 transform bg-gray-800 bg-opacity-90 rounded-2xl shadow-xl transition-all">
                <Dialog.Title
                  as="h3"
                ...
                <p className="my-4 text-base md:text-lg text-white tracking-wider text-center">
                  You have successfully purchased CGI tokens. You will receive
                  CGI tokens in your wallet once the presale ends.
                </p>
                <Dialog.Description className="mt-4 text-sm text-white tracking-wider text-center">
                  <button onClick={closeModal} className="bg-[#06765C] px-4 py-3 w-28 rounded-lg">
                    Ok
                  </button>
                </Dialog.Description>
              </Dialog.Panel>
